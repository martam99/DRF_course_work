    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_to_complete', models.TimeField(default=datetime.time(0, 2), verbose_name='Время на выполнение в секундах')),
                ...
                ('pleasant_habit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='habit.habit', verbose_name='Приятная привычка')),
            ],
            options={
